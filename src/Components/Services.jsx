...
function Services() {
  return (
    <Section id="how-to-use">
        ...
        <Heading title="Generative AI made for creators" text="Brainwave unlocks the potential of AI-powered applications"></Heading>
        <div className="relative ">
         <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[45rem] ">
            <div className="absolute top-0 left-0 pointer-events-none md:w-3/5  h-full xl:w-auto">
         ...
         <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                    <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex flex-col p-8 justify-end bg-gradient-to-b from-n-8/0 to-n-8/90" > 
